...
function makeWSProxy(url, onmsg, onopen, onclose, onerror) {
    ...
    // *********************对话Dao*****************************************//
    obj.getChatHistoryMsgs = function (beginTime, limitNum, chatId, mark) {
           doLogSendReq("get the history messages of this chat", websocket, [ "chatInit", "history", beginTime, limitNum, chatId ], mark);
    };
...
//, 66375.21107225525, ["se:m:37664649834954~-1891294528459811035"]
    ...
    obj.createNewEvent2 = function (name, pier, desc, loc, startTime, endTime, roles, dist, picture, banners, longitude, latitude, groupHead, mark) {
        doLogSendReq("events", websocket, ["events", "createEvent", name, pier, desc, loc, startTime, endTime, roles, dist, picture, banners, longitude, latitude, groupHead], mark)
    }
    ...
    obj.getParticipants = function (eventId, limit, timestamp, mark) {
        doLogSendReq("events", websocket, ["events", "getParticipants", eventId, limit, timestamp], mark)
    }
    ...
    obj.joinExhibitor = function (exhibitorId, otherId, role, eventId, mark) {
        doLogSendReq("events", websocket, ["events", "joinExhibitor", exhibitorId, otherId, role, eventId], mark)
    }
    obj.quitEvent = function (eventId, otherId, mark) {
        doLogSendReq("events", websocket, ["events", "quitEvent", eventId, otherId], mark)
    }
